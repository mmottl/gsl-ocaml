...
CAMLprim value ml_gsl_blas_dgemv(value transa, value alpha, value A, value X,
                                 value beta, value Y) {
  _DECLARE_MATRIX(A);
  _DECLARE_VECTOR2(X, Y);
  _CONVERT_MATRIX(A);
  _CONVERT_VECTOR2(X, Y);
  gsl_blas_dgemv(CBLAS_TRANS_val(transa), Double_val(alpha), &m_A, &v_X,
                 Double_val(beta), &v_Y);
  return Val_unit;
}

CAMLprim value ml_gsl_blas_dgemv_bc(value *argv, int argc) {
  return ml_gsl_blas_dgemv(argv[0], argv[1], argv[2], argv[3], argv[4],
                           argv[5]);
}

CAMLprim value ml_gsl_blas_dtrmv(value uplo, value transa, value diag, value A,
                                 value X) {
  _DECLARE_MATRIX(A);
  _DECLARE_VECTOR(X);
  _CONVERT_MATRIX(A);
...
CAMLprim value ml_gsl_blas_dtrsv(value uplo, value transa, value diag, value A,
                                 value X) {
  _DECLARE_MATRIX(A);
  _DECLARE_VECTOR(X);
  _CONVERT_MATRIX(A);
...
CAMLprim value ml_gsl_blas_dsymv(value uplo, value alpha, value A, value X,
                                 value beta, value Y) {
  _DECLARE_MATRIX(A);
  _DECLARE_VECTOR2(X, Y);
  _CONVERT_MATRIX(A);
  _CONVERT_VECTOR2(X, Y);
  gsl_blas_dsymv(CBLAS_UPLO_val(uplo), Double_val(alpha), &m_A, &v_X,
                 Double_val(beta), &v_Y);
  return Val_unit;
}

CAMLprim value ml_gsl_blas_dsymv_bc(value *argv, int argc) {
  return ml_gsl_blas_dsymv(argv[0], argv[1], argv[2], argv[3], argv[4],
                           argv[5]);
}
...
CAMLprim value ml_gsl_blas_dsyr(value uplo, value alpha, value X, value A) {
  ...
  _CONVERT_MATRIX(A);
  _CONVERT_VECTOR(X);
  gsl_blas_dsyr(CBLAS_UPLO_val(uplo), Double_val(alpha), &v_X, &m_A);
  return Val_unit;
}

CAMLprim value ml_gsl_blas_dsyr2(value uplo, value alpha, value X, value Y,
                                 value A) {
  _DECLARE_MATRIX(A);
  _DECLARE_VECTOR2(X, Y);
  _CONVERT_MATRIX(A);
  _CONVERT_VECTOR2(X, Y);
  gsl_blas_dsyr2(CBLAS_UPLO_val(uplo), Double_val(alpha), &v_X, &v_Y, &m_A);
  return Val_unit;
}

/* LEVEL3 double */

CAMLprim value ml_gsl_blas_dgemm(value transa, value transb, value alpha,
...
CAMLprim value ml_gsl_blas_dgemm_bc(value *argv, int argc) {
  return ml_gsl_blas_dgemm(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5],
                           argv[6]);
}

CAMLprim value ml_gsl_blas_dsymm(value side, value uplo, value alpha, value A,
                                 value B, value beta, value C) {
  _DECLARE_MATRIX3(A, B, C);
  _CONVERT_MATRIX3(A, B, C);
  gsl_blas_dsymm(CBLAS_SIDE_val(side), CBLAS_UPLO_val(uplo), Double_val(alpha),
                 &m_A, &m_B, Double_val(beta), &m_C);
  return Val_unit;
}

CAMLprim value ml_gsl_blas_dsymm_bc(value *argv, int argc) {
  return ml_gsl_blas_dsymm(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5],
                           argv[6]);
}

CAMLprim value ml_gsl_blas_dtrmm(value side, value uplo, value transa,
...
CAMLprim value ml_gsl_blas_dtrmm_bc(value *argv, int argc) {
  return ml_gsl_blas_dtrmm(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5],
                           argv[6]);
}

CAMLprim value ml_gsl_blas_dtrsm(value side, value uplo, value transa,
                                 value diag, value alpha, value A, value B) {
  _DECLARE_MATRIX2(A, B);
  _CONVERT_MATRIX2(A, B);
...
CAMLprim value ml_gsl_blas_dtrsm_bc(value *argv, int argc) {
  return ml_gsl_blas_dtrsm(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5],
                           argv[6]);
}

CAMLprim value ml_gsl_blas_dsyrk(value uplo, value trans, value alpha, value A,
                                 value beta, value C) {
...
CAMLprim value ml_gsl_blas_dsyrk_bc(value *argv, int argc) {
  return ml_gsl_blas_dsyrk(argv[0], argv[1], argv[2], argv[3], argv[4],
                           argv[5]);
}

CAMLprim value ml_gsl_blas_dsyr2k(value uplo, value trans, value alpha, value A,
                                  value B, value beta, value C) {
  _DECLARE_MATRIX3(A, B, C);
  _CONVERT_MATRIX3(A, B, C);
...
CAMLprim value ml_gsl_blas_dsyr2k_bc(value *argv, int argc) {
  return ml_gsl_blas_dsyr2k(argv[0], argv[1], argv[2], argv[3], argv[4],
                            argv[5], argv[6]);
}
