...
external erf : float -> float = "ml_gsl_sf_erf" "gsl_sf_erf" [@@unboxed] [@@noalloc]
external erf_e : float -> result = "ml_gsl_sf_erf_e"

external erfc : float -> float = "ml_gsl_sf_erfc" "gsl_sf_erfc" [@@unboxed] [@@noalloc]
...
external erf_Z : float -> float = "ml_gsl_sf_erf_Z" "gsl_sf_erf_Z" [@@unboxed] [@@noalloc]
external erf_Z_e : float -> result = "ml_gsl_sf_erf_Z_e"

external erf_Q : float -> float = "ml_gsl_sf_erf_Q" "gsl_sf_erf_Q" [@@unboxed] [@@noalloc]
external erf_Q_e : float -> result = "ml_gsl_sf_erf_Q_e"


(** {2 Exponential functions} *)

external exp : float -> float = "ml_gsl_sf_exp" "gsl_sf_exp" [@@unboxed] [@@noalloc]
...
external sin : float -> float = "ml_gsl_sf_sin" "gsl_sf_sin" [@@unboxed] [@@noalloc]
external sin_e : float -> result = "ml_gsl_sf_sin_e"

external cos : float -> float = "ml_gsl_sf_cos" "gsl_sf_cos" [@@unboxed] [@@noalloc]
...
external sinc : float -> float = "ml_gsl_sf_sinc" "gsl_sf_sinc" [@@unboxed] [@@noalloc]
