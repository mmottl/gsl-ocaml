...
extern int gsl_multiroot_callback_fdf(const gsl_vector *, void *, gsl_vector *,
                                      gsl_matrix *);
...
extern void gsl_multimin_callback_fdf(const gsl_vector *, void *, double *,
                                      gsl_vector *);
...
extern int gsl_multifit_callback_fdf(const gsl_vector *, void *, gsl_vector *,
                                     gsl_matrix *);

#define GSLFUN_CLOSURE(gf, v)                                                  \
  gsl_function gf = {/*.function =*/&gslfun_callback_indir, /*.params   =*/&v}
