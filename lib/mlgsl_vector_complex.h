...
#define _DECLARE_COMPLEX_VECTOR2(a, b)                                         \
  _DECLARE_COMPLEX_VECTOR(a);                                                  \
  _DECLARE_COMPLEX_VECTOR(b)

#define _CONVERT_COMPLEX_VECTOR(a) mlgsl_vec_of_value_complex(&v_##a, a)
#define _CONVERT_COMPLEX_VECTOR2(a, b)                                         \
  _CONVERT_COMPLEX_VECTOR(a);                                                  \
  _CONVERT_COMPLEX_VECTOR(b)
