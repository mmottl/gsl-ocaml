...
#define _DECLARE_VECTOR2(a, b)                                                 \
  _DECLARE_VECTOR(a);                                                          \
  _DECLARE_VECTOR(b)
#define _DECLARE_VECTOR3(a, b, c)                                              \
  _DECLARE_VECTOR2(a, b);                                                      \
  _DECLARE_VECTOR(c)
#define _DECLARE_VECTOR4(a, b, c, d)                                           \
  _DECLARE_VECTOR2(a, b);                                                      \
  _DECLARE_VECTOR2(c, d)
#define _DECLARE_VECTOR5(a, b, c, d, e)                                        \
  _DECLARE_VECTOR4(a, b, c, d);                                                \
  _DECLARE_VECTOR(e)

#define _CONVERT_VECTOR(a) TYPE(mlgsl_vec_of_value)(&v_##a, a)
#define _CONVERT_VECTOR2(a, b)                                                 \
  _CONVERT_VECTOR(a);                                                          \
  _CONVERT_VECTOR(b)
#define _CONVERT_VECTOR3(a, b, c)                                              \
  _CONVERT_VECTOR2(a, b);                                                      \
  _CONVERT_VECTOR(c)
#define _CONVERT_VECTOR4(a, b, c, d)                                           \
  _CONVERT_VECTOR2(a, b);                                                      \
  _CONVERT_VECTOR2(c, d)
#define _CONVERT_VECTOR5(a, b, c, d, e)                                        \
  _CONVERT_VECTOR4(a, b, c, d);                                                \
  _CONVERT_VECTOR(e)
