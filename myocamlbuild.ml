(* OASIS_START *)
(* DO NOT EDIT (digest: ba00c3f8a85e7e8d03023876818ad90f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("gsl", ["src"], [])];
     lib_c =
       [
          ("gsl",
            "src",
            [
               ...
               "src/mlgsl_fun.h";
               "src/mlgsl_matrix.h";
               "src/mlgsl_matrix_complex.h";
               "src/mlgsl_matrix_complex_float.h";
               "src/mlgsl_matrix_double.h";
               "src/mlgsl_matrix_float.h";
               "src/mlgsl_permut.h";
               "src/mlgsl_rng.h";
               "src/mlgsl_vector.h";
               "src/mlgsl_vector_complex.h";
               "src/mlgsl_vector_complex_float.h";
               "src/mlgsl_vector_double.h";
               "src/mlgsl_vector_float.h";
               "src/wrappers.h"
            ])
       ];
     flags =
