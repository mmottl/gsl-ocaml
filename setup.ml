...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9efcd96c8d41989aa1a5efbb195c847c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "gsl-ocaml branched off from Olivier Andrieu's distribution (ocamlgsl) and includes bug fixes as well as numerous API improvements."
              ];
          tags = [];
          categories = [];
          files_ab = ["src/gsl_version.ml.ab"];
          sections =
            [
               Flag
                 ({
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Allow building of examples using camlp4";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "F\225\011\230z\175>\156\142\139~\007w\181\218\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
