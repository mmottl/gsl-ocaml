...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5bc0b359f5c95da1971643d1831766c0) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true, ["-O2"; "-fPIC"; "-DPIC"]);
                           (OASISExpr.ETest ("system", "macosx"),
                             ["-O2"; "-fPIC"; "-DPIC"; "-framework"; "vecLib"
                             ]);
                           (OASISExpr.EAnd
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "BÝ\153\137\152C\128ø¿þ\b¦Ug¤3";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
