...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3ecb284204e2d097b52f01911612f8d0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2002-2012 Olivier Andrieu <oandrieu@gmail.com>\n(C) 2009-2014 Markusk Mottl <markus.mottl@gmail.com>"
            ];
          ...
          homepage = Some "http://mmottl.github.io/gsl-ocaml";
          synopsis = "GSL - Bindings to the GNU Scientific Library";
          description =
            Some
              [
                 OASISText.Para
                   "GSL - Bindings to the GNU Scientific Library This version branched off from Olivier Andrieu's distribution (ocamlgsl) and includes patches as well as numerous API improvements."
              ];
          categories = [];
          ...
          files_ab = ["lib/gsl_version.ml.ab"];
          sections =
            [
               Flag
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "blas_speed_test.ml"});
               Executable
                 ({
                     cs_name = "bspline_ex";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "combi_ex.ml"});
               Executable
                 ({
                     cs_name = "const_ex";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "multifit_data_ex.ml"
                   });
               Executable
                 ({
                     cs_name = "multifit_ex";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "multifit_nlin_ex.ml"
                   });
               Executable
                 ({
                     cs_name = "multimin_ex";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mmottl/gsl-ocaml.git";
                      src_repo_browser =
                        Some "https://github.com/mmottl/gsl-ocaml";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "1ÿ\150ªk±\022\159\t5¥\149 œ@\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
