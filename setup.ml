...
(* OASIS_START *)
(* DO NOT EDIT (digest: e9f319c4147328862f862d696b2ffd4c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = ["(C) 2002-2012 Olivier Andrieu <oandrieu@merim.net>"];
          maintainers =
            [
               "Olivier Andrieu <oandrieu@merim.net>";
                      ...
                      bs_ccopt =
                        [
                           ...
                           (OASISExpr.ETest ("system", "macosx"),
                             ["-O2"; "-DPIC"; "-framework"; "vecLib"])
                        ];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true, ["-lcblas"]);
                           (OASISExpr.ETest ("system", "macosx"),
                             ["-framework"; "vecLib"])
                        ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "H¬\144\150®ÅmÆ\130ý\137ö<<GT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
